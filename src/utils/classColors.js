...
export const CLASS_META = {
  ...
  two_wheeler:      { color: "#ff0000", label: "2-Wheeler",      icon: "🏍️" },
  three_wheeler:    { color: "#ffd400", label: "3-Wheeler",      icon: "🛺" },
  six_plus_wheeler: { color: "#a020f0", label: "6+ Wheeler",     icon: "🚛" },
  person:           { color: "#00ff00", label: "Person",         icon: "🚶" },
